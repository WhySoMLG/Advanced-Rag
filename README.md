...
- **Streamlit chat UI** — multi-turn conversations with source attribution and RRF score display
...
Example — swap to a larger Whisper model for better audio accuracy:
